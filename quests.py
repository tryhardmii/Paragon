from items import weaponlist
def questupdate(player1, questmaster1,file,requesttype):
    class quest:
    ...
    questlist = {
        "questmaster":[
            #area 1 quests
            quest(stringlist[0],player.mobsdefeated["npctalk"],5),
    ...
    if requesttype == "questlist":
        ...
        if player.currentquest == 0:
            ...
            print(questlist[questmaster.name][player.currentquest].currentvalue,questlist[questmaster.name][player.currentquest].totalvalue)
