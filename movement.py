...
def movement():
    ...
    #chest declarations
    chest1 = chest("chest1", 175, 178, "sigma alpha gyatt sword")
    chest2 = chest("chest1", 140, 150, "sigma alpha gyatt sword")
    chest3 = chest("chest1", 127, 94, "sigma alpha gyatt sword")
    ...
    while game_active:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_5:
                    ...
                    player1.inventory["drops"].append(item("Tooth","graphics/drops/tooth.png",500))
        ...
        if validmovement == True and interactingnpc == 0:  # movement code
            ...
            if player1.movementframe <= 32 and movementkey != "":
                ...
                if player1.movementframe == 32:
                    for y in grassgroup:
                        i = y.encounter(player1,difficulty)
                        if i!=0:
                            player1 = i
                            movementkey = ("")
                            movementkeys.clear()
            ...
            try:
                if interactingnpc.dialoguetype == "random":
                    ...
                    if interactingnpc.dialoguenum >= len(oldwoman.dialogue):
                        ...
                        if i!=0:
                            questmaster =i
                        oldman.dialogue = ["I sure am grateful!"]
        ...
        if inventoryrequest == 1:
            try:
                ...
                blockmovement = True
                inventory1 = inventory(player1.inventory, 608, 480)
            inventoryrequest = 0
                    ...
                    if interactingnpc!=0:
                        if interactingnpc.type=="npc":
                            if interactingnpc.name != "questmaster" and interactingnpc.name != "wizard" and interactingnpc.name != "shop" and interactingnpc.talked==0:
                                try:
                                    crashtest = questmasterinfo.questlist
        ...
        background[backgroundkey].posx = 608 - (32 * player1.tilex - player1.displacedx)
        ...
        if controls_view == True:
            screen.blit(controls_image,(32,32))
        pygame.display.update()
        pygame.time.Clock().tick(60)
    pygame.quit()